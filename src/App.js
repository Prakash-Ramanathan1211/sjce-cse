...
import EventsWrapper from "./screens/Events/EventsWrapper";
...
import ResearchScholarMain from  "./screens/Research/ResearchScholars/ResearchScholarMain";
import ResearchScholarSingle from  "./screens/Research/ResearchScholars/ResearchScholarSingle";
    ...
    <div className="App">
      ...
      <HashRouter>
        ...
        <Switch>
          ...
          <Route path="/research-scholars" component={ResearchScholarMain} />
          ...
          {/* <Route path="/scholar-details" component={ResearchScholarMain} /> */}
          <Route path="/scholars/:id" component={ResearchScholarSingle}/>
